...
WebUI.click(findTestObject('Object Repository/Page_ParaBank  Accounts Overview/b_1000.00'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_ParaBank  Accounts Overview/b_1000.00'), '$1000.00')
